...
ใช้ร่วมกับ `CoreAiWorkspaces/04-way-of-work/coding-standards.md` (core standards ยังใช้ทั้งหมด)
...
| G-04 | Feature ไม่มี FDD | task `in_progress` แต่ไม่มี FDD ใน `CoreAiWorkspaces/08-design/` |
