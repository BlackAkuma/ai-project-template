...
ใช้ร่วมกับ `doc/04-way-of-work/coding-standards.md` (core standards ยังใช้ทั้งหมด)
...
## 7. Game-Specific Compliance Rules (เพิ่มจาก core)
...
| G-04 | Feature ไม่มี FDD | task `in_progress` แต่ไม่มี FDD ใน `doc/08-design/` |
