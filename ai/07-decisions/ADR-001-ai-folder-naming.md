# ADR-001: เลือก ai/ เป็นชื่อ AI working folder
...
1. **ai/** — สื่อความหมายชัดเจน ไม่ชนกับ docs/ — Pro: ชัดเจน, distinct Con: ต้อง rename ทุกไฟล์
2. **doc/** (เดิม) — Pro: สั้น Con: สับสนกับ docs/, ไม่สื่อว่าเป็น AI workspace
3. **workspace/** — Pro: ทั่วไป Con: ไม่ชัดว่าเป็น AI-related
4. **context/** — Pro: บอกว่าเป็น context สำหรับ AI Con: ยาวกว่า ai/
...
- เป็น naming convention ที่เริ่มใช้กันใน developer community (เช่น .cursorrules → ai/)

## Consequences

- **ง่ายขึ้น:** user เข้าใจโครงสร้างทันที — ai/ คือที่ AI ทำงาน, docs/ คือเว็บ
...
ถ้า community standard เปลี่ยนไปใช้ชื่ออื่น (เช่น .ai/ มี special meaning) ให้ revisit
