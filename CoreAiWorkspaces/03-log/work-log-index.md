...
tool: Claude Code
completed: [T-040]
checkpoint: P3-2 done — engine/govern.py gated mark_done (only legit path: gate→done+signed event) + audit detects faked-done (7/7 tests). Constitutive at data level proven (24 tests total). next P3-3 FS-allowlist/fuller interception. G1=C-conservative (ADR-011)
