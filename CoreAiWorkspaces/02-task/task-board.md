...
priority_next: carry-over remediation T-051/052/053 (implement Accepted ADR-007/008 in shipped core — reverse uniform-gate→tiered, C-07 invert) via Scenario O review; OR adversarial suite expansion. Engine soft-ship-ready (45 tests + demo + OSS pkg). G1/G3/G4 locked (ADR-011/012/013)
