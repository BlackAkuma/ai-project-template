...
priority_next: P4-2 render full work-status/task-board markdown from store (then T-057 apply unified schema). P4-1 done (store.py canonical+view, drift=0, 31 tests, CI runs all). G3=C-deferred (ADR-012)
