...
```
Setup CoreAiWorkspaces/ system for this project.
- Name: [PROJECT_NAME]
...
Claude Code reads `CLAUDE.md` + all of `core/` + `skills/game/` (if game) and builds `CoreAiWorkspaces/` for you.
...
Claude Code อ่าน `CLAUDE.md` + `core/` ทั้งหมด + `skills/game/` (ถ้าเป็นเกม) แล้วสร้าง `CoreAiWorkspaces/` ให้
