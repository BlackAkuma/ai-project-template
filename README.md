...
The script reads directly from `core/` and `skills/game/`, strips template meta-headers, and produces clean project files with your project name substituted throughout. Output is verified against a 108-check audit suite.
...
Script อ่านจาก `core/` และ `skills/game/` โดยตรง ตัด template header ออก และแทนที่ชื่อโปรเจ็กต์ทั่วทุกไฟล์ ผ่านการตรวจ 108 จุดด้วย audit suite
