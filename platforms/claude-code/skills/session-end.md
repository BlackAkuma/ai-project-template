...
7. **agent diary** — ถ้า `ai/03-log/agents/` มีอยู่ ให้เพิ่ม entry ใน `ai/03-log/agents/claude-code.md`:
...
8. **daily log** — ถ้ามีงานที่ต้องบันทึกรายละเอียด ให้เพิ่มหรือสร้าง `ai/03-log/YYYY/MM/YYYY-MM-DD-log.md`
