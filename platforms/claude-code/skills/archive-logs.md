...
2. สร้าง `doc/03-log/archive/YYYY-MM-sessions.md` สำหรับแต่ละเดือนที่ archive
...
2. ย้ายไป `doc/02-task/archive/done-YYYY-MM.md`
...
Log archive:
  สร้าง doc/03-log/archive/2026-01-sessions.md (23 sessions)
  สร้าง doc/03-log/archive/2026-02-sessions.md (18 sessions)
  work-log-index: 340 บรรทัด → 87 บรรทัด

Task archive:
  ย้าย 12 done tasks → doc/02-task/archive/done-2026-01.md
