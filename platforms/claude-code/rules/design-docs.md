...
Rules สำหรับไฟล์ทั้งหมดใน doc/ — โหลดอัตโนมัติเมื่อแก้ไข documentation
...
- ถ้าต้องเพิ่ม context: สร้าง extension doc ใน doc/06-extensions/
...
## FDD (doc/08-design/) — Game Projects
