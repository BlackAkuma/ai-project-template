...
- `CoreAiWorkspaces/08-design/art-bible.md` — visual identity, color palette, style standards (if exists)
- `CoreAiWorkspaces/08-design/asset-registry.md` — registered assets and their status
...
|------|-----------------|
| A-01 | Asset used in code but not in `CoreAiWorkspaces/08-design/asset-registry.md` |
