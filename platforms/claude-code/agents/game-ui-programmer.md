...
- Relevant UX spec in `CoreAiWorkspaces/08-design/ux-spec-[screen-id].md`
- `CoreAiWorkspaces/08-design/art-bible.md` — visual standards for UI
- `CoreAiWorkspaces/07-decisions/README.md` — UI framework ADRs
