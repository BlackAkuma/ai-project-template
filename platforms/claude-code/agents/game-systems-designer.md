...
- `CoreAiWorkspaces/00-source/versions/v0.1/gdd.md` — core systems and balance philosophy
- `CoreAiWorkspaces/08-design/difficulty-curve.md` — difficulty axes and tuning targets
