...
- `doc/08-design/character-registry.md` — all registered speakers and character IDs
- `doc/00-source/versions/v0.1/gdd.md` — game pillars and player fantasy (narrative must serve these)
- Any `doc/08-design/character-[id].md` files relevant to current task
...
- Character sheet creation and maintenance (`doc/08-design/character-[id].md`)
...
| N-04 | Speaker ID not registered in `doc/08-design/character-registry.md` |
