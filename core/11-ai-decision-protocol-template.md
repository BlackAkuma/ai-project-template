...
นำไปวางใน `ai/04-way-of-work/ai-decision-protocol.md` ของโปรเจ็กต์
...
T-022 [in_progress]: implement product search
  ref: ai/00-source/versions/v1.0/03-search.md  ← source version เก่า
...
→ เปิด ai/07-decisions/entity-register.md
...
1. เป็น architectural decision?
   → ADR (ai/07-decisions/ADR-NNN-*.md + README.md)
