...
| `deep_context` | path ไปยัง history เพิ่มเติมถ้าต้องการ | `archive: ai/03-log/archive/` หรือ `none` |
...
2. เขียน monthly summary ไว้ใน ai/03-log/archive/YYYY-MM-sessions.md
...
```
1. ย้าย task done ที่เก่ากว่า 30 วัน ไปที่ ai/02-task/archive/done-YYYY-MM.md
...
- **ผลลัพธ์:** <RESULT>
- **Daily Log:** `ai/03-log/YYYY/MM/YYYY-MM-DD-log.md`
```
...
- `ai/03-log/YYYY/MM/YYYY-MM-DD-log.md`
```
...
deep_context: archive: ai/03-log/archive/2026-02-sessions.md
-->
...
- **Daily Log:** `ai/03-log/2026/04/2026-04-25-log.md`
...
- **Daily Log:** `ai/03-log/2026/04/2026-04-20-log.md`
```
...
**กฎ Recent Sessions:**
- เก็บแค่ 20 entries — entry เก่ากว่านั้น archive ไปที่ `ai/03-log/archive/`
...
สร้างไฟล์ `ai/03-log/agents/<tool-name>.md` ต่อ tool ที่ใช้
