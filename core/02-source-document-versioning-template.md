...
- revision จริงเก็บใต้ `doc/00-source/versions/`
- ไฟล์ชื่อหลักใน `doc/00-source/` เป็น pointer/index เท่านั้น
...
- `v0.2`
- ไฟล์หลัก: `doc/00-source/versions/v0.2/02-PRD.md`

## Previous Versions

- `v0.1`: `doc/00-source/versions/v0.1/02-PRD.md`
