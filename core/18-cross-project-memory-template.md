...
ถ้าต้องการแชร์กับทีม ให้ curate เฉพาะส่วนที่ไม่ sensitive แล้ว copy ไปที่ project ai/
...
- อ่านตอน bootstrap โปรเจ็กต์ใหม่ก่อนสร้าง ai/ structure
...
- **project-name/ADR-NNN**: ชื่อ decision — สรุปสั้น
  ...
  Path: ~/projects/project-name/ai/07-decisions/ADR-NNN-*.md
-->
...
- **project-alpha/ADR-003**: Stripe integration pattern — ใช้ SDK official + idempotency key
  ...
  Path: ~/projects/project-alpha/ai/07-decisions/ADR-003-stripe-integration.md
