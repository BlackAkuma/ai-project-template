...
คัดลอกและปรับไฟล์นี้เป็น `CoreAiWorkspaces/01-plan/work-status.md`
...
read_more:
  ...
  source_current: CoreAiWorkspaces/00-source/versions/<CURRENT_SOURCE_VERSION>/
...
read_more:
  architecture: CoreAiWorkspaces/07-decisions/README.md
  entities: CoreAiWorkspaces/07-decisions/entity-register.md
  source_current: CoreAiWorkspaces/00-source/versions/v0.2/
updated: 2026-04-28
-->
```
