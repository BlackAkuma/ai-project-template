...
คัดลอกและปรับไฟล์นี้เป็น `doc/01-plan/work-status.md`
...
| `git_prod_branch` | production branch — ห้าม commit doc/ ที่นี่ | `main` |
| `git_dev_branch` | dev branch ที่ AI ทำงานและ doc/ อาศัยอยู่ | `dev` |
...
read_more:
  ...
  source_current: doc/00-source/versions/<CURRENT_SOURCE_VERSION>/
