...
คัดลอกและปรับไฟล์นี้เป็นเอกสารภายใต้ `ai/06-extensions/`
...
- `ai/00-source/versions/v1.1/02-auth-requirements.md` — Section 3.2: "ทุก endpoint ต้องผ่าน JWT middleware"
...
T-XXX: [NEEDS HUMAN DECISION] Resolve auth middleware vs source v1.1 conflict
  ref: ai/06-extensions/conflict-auth-middleware-2026-04-28.md
...
3. สร้าง extension doc ใน ai/06-extensions/reverse-<ชื่อ>.md โดยใช้ template ด้านบน
