...
คัดลอกและปรับไฟล์นี้เป็น `ai/04-way-of-work/way-of-work.md`
...
1. `ai/01-plan/work-status.md` — อ่าน AI-CONTEXT block ก่อน
2. `ai/03-log/work-log-index.md` — อ่าน AI-CONTEXT block ก่อน
3. `ai/02-task/task-board.md` — อ่าน AI-CONTEXT block ก่อน
4. `ai/01-plan/project-plan.md`
5. `ai/04-way-of-work/coding-standards.md`
6. source doc index ใน `ai/00-source/`
7. source docs เวอร์ชันปัจจุบันใน `ai/00-source/versions/`
...
- business/product source docs: `ai/00-source/versions/<CURRENT_SOURCE_VERSION>/...`
- แผนหลัก: `ai/01-plan/project-plan.md`
- สถานะล่าสุด: `ai/01-plan/work-status.md`
- งานและ ticket: `ai/02-task/task-board.md`
- handoff summary: `ai/03-log/work-log-index.md`
...
1. `ai/01-plan/work-status.md` — สถานะปัจจุบัน
2. `ai/02-task/task-board.md` — งานที่กำลังทำ
3. `ai/03-log/work-log-index.md` — สิ่งที่ทำไปแล้ว (entry ล่าสุด)
4. `ai/07-decisions/README.md` — ADR index (ป้องกัน reverse decisions)
...
- ถ้าโปรเจ็กต์ใช้ AI tool มากกว่า 1 ตัว ให้สร้าง `ai/03-log/agents/<tool-name>.md` ต่อ tool
- แต่ละ tool เขียน diary ของตัวเองเท่านั้น — ห้าม cross-write
- ตัวอย่างไฟล์: `ai/03-log/agents/claude-code.md`, `ai/03-log/agents/claude-ai.md`
...
|-------------|--------|
| Architectural decision | `ai/07-decisions/ADR-NNN-*.md` |
| Entity ใหม่ หรือ status เปลี่ยน | `ai/07-decisions/entity-register.md` |
| Pattern / lesson ข้ามโปรเจ็กต์ | `~/ai-workspace/cross-project-memory.md` (ถามผู้ใช้ก่อน) |
| Progress / detail / decisions ใน session | `ai/03-log/agents/<tool>.md` + `work-log-index.md` |
| Task ใหม่ หรือ status เปลี่ยน | `ai/02-task/task-board.md` |
...
- รายละเอียดเพิ่มเติม: ดู Scenario K ใน `ai/04-way-of-work/ai-decision-protocol.md`
