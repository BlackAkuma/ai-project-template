...
- ถ้าโปรเจ็กต์ใช้ AI tool มากกว่า 1 ตัว ให้สร้าง `doc/03-log/agents/<tool-name>.md` ต่อ tool
- แต่ละ tool เขียน diary ของตัวเองเท่านั้น — ห้าม cross-write
- ตัวอย่างไฟล์: `doc/03-log/agents/claude-code.md`, `doc/03-log/agents/claude-ai.md`
...
| Entity ใหม่ หรือ status เปลี่ยน | `doc/07-decisions/entity-register.md` |
| Pattern / lesson ข้ามโปรเจ็กต์ | `~/ai-workspace/cross-project-memory.md` (ถามผู้ใช้ก่อน) |
| Progress / detail / decisions ใน session | `doc/03-log/agents/<tool>.md` + `work-log-index.md` |
| Task ใหม่ หรือ status เปลี่ยน | `doc/02-task/task-board.md` |
...
- รายละเอียดเพิ่มเติม: ดู Scenario K ใน `doc/04-way-of-work/ai-decision-protocol.md`
