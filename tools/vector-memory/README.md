...
# 2. mine CoreAiWorkspaces/ — ต้องระบุ --wing เสมอ (ไม่งั้น wing = 'ai' ชนทุกโปรเจ็กต์)
mempalace mine CoreAiWorkspaces/ --wing <project-name>
...
# อัปเดต index หลังแก้ CoreAiWorkspaces/
mempalace mine CoreAiWorkspaces/ --wing <project-name>
...
|--------------|-----------|
| `CoreAiWorkspaces/` ของโปรเจ็กต์นี้ | ชื่อโปรเจ็กต์ (lowercase, hyphen) |
| ค้นข้ามทุกโปรเจ็กต์ | ไม่ใส่ `--wing` |

**กฎ:** ต้องระบุ `--wing` ทุกครั้งที่ mine `CoreAiWorkspaces/` subfolder
