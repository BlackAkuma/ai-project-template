...
**`ai/03-log/agents/claude-code.md`** — Claude Code เขียน
**`ai/03-log/agents/claude-ai.md`** — Claude.ai web เขียน (ด้วยมือหลัง session)
...
3. Upload ไฟล์ `ai/` ที่สำคัญเข้า Project Knowledge:
...
```
paste ai/04-way-of-work/compliance.md
