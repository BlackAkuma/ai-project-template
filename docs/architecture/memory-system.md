...
→ เปิดเมื่อ CoreAiWorkspaces/ มีไฟล์มากกว่า 30 ไฟล์ หรือโปรเจ็กต์ทำมานานกว่า 3 เดือน
...
**ไฟล์:** `CoreAiWorkspaces/07-decisions/entity-register.md`
...
- `CoreAiWorkspaces/` มีไฟล์มากกว่า 30 ไฟล์ และหา context ยากขึ้น
...
□ vector_memory: enabled + CoreAiWorkspaces/ เปลี่ยน → re-index
```
